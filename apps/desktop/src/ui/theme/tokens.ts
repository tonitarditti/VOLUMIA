...
export const themeTokens: Record<Theme, ThemeTokens> = {
  ...
  dark: {
    ...
    surface2: "#10172B",
    surface3: "#15203A",
    surfaceRaised: "#1B2948",
    inputBg: "rgba(255, 255, 255, 0.04)",
    inputBorder: "rgba(124, 136, 166, 0.34)",
    border: "rgba(124, 136, 166, 0.24)",
    borderStrong: "rgba(181, 196, 226, 0.34)",
    text: "#EAF1FF",
    textMuted: "rgba(216, 227, 248, 0.74)",
    textFaint: "rgba(170, 187, 216, 0.6)",
    textInverse: sharedTokens.textInverse,
    accentPrimary: sharedTokens.accentPrimary,
    accentPrimaryHover: sharedTokens.accentPrimaryHover,
    accentPrimarySoft: sharedTokens.accentPrimarySoft,
    ...
    shellContrastPanel: "#060A16",
    shellContrastSurface: "rgba(255, 255, 255, 0.045)",
    shellContrastBorder: "rgba(184, 197, 216, 0.17)",
    shellContrastText: "#EAF1FF",
    shellContrastTextMuted: "rgba(176, 194, 224, 0.78)",
